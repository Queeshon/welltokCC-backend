...
article7 = Article.create(
  ...
  description: "Google made almost all its money from ads. It was a booming business — until it wasn’t. Here’s how things looked right before the most spectacular crash the technology industry had ever seen.
...
article8 = Article.create(
  title: "Universities are broke. So let’s cut the pointless admin and get back to teaching",
  description: "A
...
article9 = Article.create(
  title: "New and improved bike routing, with low stress options",
  description: "Bicyclists ride to commute, to exercise, for sport, for leisure. But no matter the reason, most cyclists will ride on the road at some point, and when they do, they’ll think about the safety and comfort of their route.
...
article10 = Article.create(
  ...
  description: "D was designed from the ground up to interface directly and easily to C, and to a lesser extent C++. This provides access to endless C libraries, the Standard C runtime library, and of course the operating system APIs, which are usually C APIs.
...
article11 = Article.create(
  title: "Why I haven't jumped ship from Common Lisp to Racket (just yet)",
  description: "Matthias Felleisen jested 'Why are you still using CL when Scrbl/Racket is so much better :-)' ? My response was as follows:
Dear Matthias,
...
article12 = Article.create(
  title: "Exxon Duped Public Over Climate Concerns, Harvard Research Says",
  description: "Exxon Mobil Corp. spent the last 40 years undermining public concern over climate change, even as its own scientists determined man-made global warming was real and a serious threat, according to Harvard University researchers writing in a peer-reviewed journal.
...
article13 = Article.create(
  title: "Mathematicians Tame Rogue Waves, Illuminating Future of LED Lighting",
  description: "In the 1950s, Philip Anderson, a physicist at Bell Laboratories, discovered a strange phenomenon. In some situations where it seems as though waves should advance freely, they just stop — like a tsunami halting in the middle of the ocean.
...
article14 = Article.create(
  title: "Write a hash table in C",
  description: "Hash tables are one of the most useful data structures. Their quick and scalable insert, search and delete make them relevant to a large number of computer science problems.
...
C is a great language to write a hash table in because:
	•	The language does not come with one included
...
article15 = Article.create(
  title: "Google unveils a new, cheaper networking option for cloud customers: the public internet",
  description: "Google Cloud Platform customers will have a new option when selecting the type of network used to deliver their traffic to their users: they can keep using Google’s network, or they can save some money with the new option of using public transit networks.
